	const bannerHTML = `
	<div class="banner-container-nmd" onclick="window.location.href='${bannerLink}';">
		<div class="slide-cpng-banner-back-nmd">
			<img src="https://img3c.coupangcdn.com/image/affiliate/event/promotion/2024/06/04/932fb093deac002c018724482a895096.png" alt="Icon">
		</div>
		<div class="slide-cpng-banner-front-nmd">
			<img class="front-img-nmd" src="https://i.postimg.cc/qBPpSRyW/a1.png" alt="Icon">
			<div class="slide-cpng-banner-rightbox-nmd arw">
				<div class="slide-cpng-banner-rightbox-arrow-nmd">
					<img src="https://img.planbplus.co.kr/sliding/img/sliding75/arw.png" alt="Arrow">
				</div>
			</div>
		</div>
	</div>
